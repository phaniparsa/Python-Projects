...
def readInputGraph():
    file_Handler = open("C:/Users/useradmin/Desktop/Matin/Python-Projects/FASTPPR_Originalcode/input1.txt", 'r')
...
def write_Output():
    results.to_csv("C:/Users/useradmin/Desktop/Matin/Python-Projects/FASTPPR_Originalcode/Reduced_PPR_Estimates.csv", index = False)
    return 
